...
use crate::universal_io::{ReadPipelineImpl, Result, UserData};
...
impl<'file, File, Inner, U> ReadPipelineImpl<'file, U> for WrappedReadPipeline<File, Inner>
where
    File: TransparentWrapper<Inner::File> + 'file,
    Inner: ReadPipelineImpl<'file, U>,
    U: UserData,
{
    type File = File;
